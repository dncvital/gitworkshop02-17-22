...
class Animation(object):
    ...
    def get_image(self, x, y, width, height):
        ...
        image = pygame.Surface( &  # 91;width,height]).convert()
    ...
    def get_current_image(self):
        return self.image_list &  # 91;self.index]
